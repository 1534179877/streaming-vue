  ...
  <div>
    ...
    <el-row style="height: 90vh" type="flex" align="middle">
      <el-col class="player-col">
        ...
        <el-row>
          <giftbar class="giftbar" :liverId="live.user._id" @sendgiftmeg="sendgift"></giftbar>
        </el-row>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    sendgift(data) {
      console.log(data)
      this.ws.send(JSON.stringify({ id: this.userId, nick: this.nick, msg: `赠送了${data.num}个${data.gift}` }))
    },
    async init() {
